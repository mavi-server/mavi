...
declare namespace BlueServer {
  /**
   * Blueserver fundamental configuration types
   */
  interface Config {
    /**
     * Port to listen on
  ...
  interface Route {
     ...
     * 
     */
    method: BlueServer.methods;
    /**
     * Controller option.
     * 
     * `upload` controller may have issues.
     */
    controller: BlueServer.controllers;
    /** 
    ...
    */
    middlewares?: string | string[] | middleware | BlueServer.middlewares[];
    /**
  ...
  */
  namespace Model {
    type types = "increments" | "integer" | "bigInteger" | "text" | "string" | "float" | "double" | "decimal" | "boolean" | "date" | "datetime" | "time" | "timestamp" | "timestamps" | "binary" | "enum" | "json" | "jsonb" | "uuid" | "geometry" | "geography" | "point";
